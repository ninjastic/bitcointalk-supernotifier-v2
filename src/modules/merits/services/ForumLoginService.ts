...
export default class LoginService {
    public async execute(): Promise<void> {
        ...
        const response = await fetch(`https://bitcointalk.org/index.php?action=login2;ccode=${process.env.BITCOINTALK_BYPASS_CAPTCHA_CODE}`, { method: 'POST', body: bodyFormData, redirect: 'manual' })
